...
// intro
router.get('/', getClientId, function(req, res) {
    res.render('intro')
})
...
router.post('/writeLog.html', function(req, res) {
    ...
    } else if (operation === 'changeLangByTouchOperName') {
        unitId = logCfg[req.query.currentlang] + ',IDM:' + req.query.unitId
    } else {
...
router.post('/writeLogAp.html', function(req, res) {
    ...
    var info = logCfg[msg] + 'がありません。（' + logCfg[currentLang] + '）'
