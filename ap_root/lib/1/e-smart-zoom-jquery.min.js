function transitionEnd() {
	...
	e.fn.smartZoom = function(t) {
		...
		if (i[t]) {
			...
			e.error("Method " + t + " does not exist on e-smartzoom $jq plugin")
		}
	}
})($jq);
(function(e) {
...
$jq.fn.emulateTransitionEnd = function(e) {
	var t = false,
		n = this;
	$jq(this).one($jq.support.transition.end, function() {
		t = true
	});
	var r = function() {
		if (!t) $jq(n).trigger($jq.support.transition.end)
	};
	setTimeout(r, e);
	return this
};
