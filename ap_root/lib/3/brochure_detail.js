...
brochureDetail.prototype = {
    init: function() {
        ...
        if (fileExt == '.pdf') {
            ...
            $('#pdf').append('<embed  height="1000" width="100%" src="../rf_images/brochure/' + data.pdf + '#toolbar=0&navpanes=0&scrollbar=1"></embed>')
        } else {
            $('#pdf').append('<img id="imageFullScreen" height="1000" width="100%" src="../rf_images/brochure/' + data.pdf + '#toolbar=0"></img>')
